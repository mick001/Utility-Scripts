"""
Created on Sun Nov 20 13:01:56 2016

@author: Michy
@name: Threephase balanced radial electrical line solver
@description:
    This short snippet of code is aimed at solving a threephase balanced radial electrical line.
    It is useful for doing a quick double check if you are solving the circuit using pen and paper.
    
@examples:
	Check out the example of how it works at line 163 and at https://firsttimeprogrammer.blogspot.com/2016/11/solving-electrical-radial-lines-with.html
